...
class Config():
    ...
    model_name = 'DQN_PS_Com_min_batch'
...
class QNParamSharingComAgent:
    ...
    def get_best_action(self, state):
        ...
        return best_joint_action, action_values_joint
    ...
    def get_action(self, states, is_training=True):
        ...
        Args:
            state: observation from gym
        """
        best_joint_action,_ = self.get_best_action(states)
        ...
        while True:
            ...
            if new_cycle:
                ...
                if num_episodes % (Config.num_train_episodes + Config.num_eval_episodes) < Config.num_train_episodes: #TRAINING
                    ...
                    action_new = self.get_action(state_new, True)
